...
app=FastAPI(title="URL Shortener API",description="A simple API to shorten and resolve URLs.")
...
@app.post('/shorten',response_model=URLResponse,summary="Create short URL", description="Generate a short URL code from a long URL.")
...
@app.get('/show',summary="Show all short codes",description="Returns all short codes and their original URLs if query parameter `show=all` is provided.")
...
@app.get('/admin',summary="Get access logs of a shortcode",description="Returns the 10 most recent timestamps for a given shortcode, along with its total visit count.")
...
@app.get('/{code}',summary="Get the original url of the short code",description="Returns a redirect to the original url")
